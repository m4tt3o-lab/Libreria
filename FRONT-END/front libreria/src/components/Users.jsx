      ...
      const removeUser = async (id) => {
        ...
        try {
          ...
          if (response.ok) {
            ...
            alert('impossibile eliminare un utente che ha un prestito ancora attivo')
          }
        } catch (error) {
        ...
        <div className="container-fluid p-0 m-0">
          <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <div className="container-fluid">
              <span style={{ fontSize: '34px', marginRight:'22px', fontStyle:'oblique' }}><b>Utenti <i className="bi bi-people"></i></b></span>
