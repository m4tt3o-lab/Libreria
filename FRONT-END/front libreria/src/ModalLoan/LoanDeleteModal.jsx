...
const ConfirmDeleteLoanModal = ({ isOpen, onClose, onConfirm, itemName, error }) => {
    return (
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p>Sei sicuro di voler eliminare il prestito ?</p>
...
export default ConfirmDeleteLoanModal;
